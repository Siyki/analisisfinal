    ...
    try:
        ...
        with tab3:
            ...
            with col1:
                ...
                min_val = st.slider(
                    'Valor mínimo',
                    float(df1["variable"].min()),
                    float(df1["variable"].max()),
                    float(df1["variable"].mean()),
                    key="min_val"
                )
                
                filtrado_df_min = df1[df1["variable"] > min_val]
                st.write(f"Registros con valor superior a {min_val}:")
            ...
            with col2:
                ...
                st.write(f"Registros con valor inferior a {max_val}:")
